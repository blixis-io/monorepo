/**
 * UUIDv7 identifiers (RFC 9562, ADR 0007), generated with Web Crypto. Dependency-free so every
 * package (events, database, …) can create IDs without pulling in a database driver.
 */
